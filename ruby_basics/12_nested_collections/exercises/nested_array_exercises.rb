def blank_seating_chart(number_of_rows, seats_per_row)
  ...
  nested = Array.new(number_of_rows) { Array.new(seats_per_row)}
  return nested
...
def find_favorite(array_of_hash_objects)
  ...
  array_of_hash_objects.each_with_index do |row, index|
    array_of_hash_objects[index].each_value do |value|
      if value === true
